...
const Chatbot = () => {
    ...
    useEffect(() => {
        if (isOpen) {
            ...
            if (firstOpen) {
                setMessages([{ sender: "bot", text: "Hello! I am Pustak Prabandha Chatbot. Ask me anything about the library. How can I assist you today?" }]);
                setFirstOpen(false);
            }
        }
    }, [isOpen]);
            ...
            {isOpen && (
                <div className="chatbot-container" ref={chatWindowRef}>
                    <div className="chatbot-header">
                        <span><FcReadingEbook size={20} /> Pustak Prabandha</span>
